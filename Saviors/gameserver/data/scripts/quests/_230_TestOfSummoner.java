...
public final class _230_TestOfSummoner extends Quest
{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		{ // start part, Galatea
			...
			if(st.getPlayer().getClassId() == ClassId.WIZARD || st.getPlayer().getClassId() == ClassId.ELVEN_WIZARD || st.getPlayer().getClassId() == ClassId.DARK_WIZARD)
				...
				{
					htmltext = "high_summoner_galatea_q0230_02.htm"; // too young.. not now
				}
			else
			{ // wrong class.. never
				htmltext = "high_summoner_galatea_q0230_01.htm";
			}
		}
		else
		{
	...
	static
	{
		...
		{ CRYSTAL_OF_PROGRESS1_ID, CRYSTAL_OF_INPROGRESS1_ID, CRYSTAL_OF_FOUL1_ID, CRYSTAL_OF_DEFEAT1_ID, CRYSTAL_OF_VICTORY1_ID }); // Pako the Cat
		DROPLIST_SUMMON.put(27103, new Integer[]
		{ CRYSTAL_OF_PROGRESS2_ID, CRYSTAL_OF_INPROGRESS2_ID, CRYSTAL_OF_FOUL2_ID, CRYSTAL_OF_DEFEAT2_ID, CRYSTAL_OF_VICTORY2_ID }); // Mimi the Cat
		DROPLIST_SUMMON.put(27104, new Integer[]
		{ CRYSTAL_OF_PROGRESS3_ID, CRYSTAL_OF_INPROGRESS3_ID, CRYSTAL_OF_FOUL3_ID, CRYSTAL_OF_DEFEAT3_ID, CRYSTAL_OF_VICTORY3_ID }); // Shadow Turen
		DROPLIST_SUMMON.put(27105, new Integer[]
		{ CRYSTAL_OF_PROGRESS4_ID, CRYSTAL_OF_INPROGRESS4_ID, CRYSTAL_OF_FOUL4_ID, CRYSTAL_OF_DEFEAT4_ID, CRYSTAL_OF_VICTORY4_ID }); // Unicorn Racer
		DROPLIST_SUMMON.put(27106, new Integer[]
		{ CRYSTAL_OF_PROGRESS5_ID, CRYSTAL_OF_INPROGRESS5_ID, CRYSTAL_OF_FOUL5_ID, CRYSTAL_OF_DEFEAT5_ID, CRYSTAL_OF_VICTORY5_ID }); // Unicorn Phantasm
		DROPLIST_SUMMON.put(27107, new Integer[]
		{ CRYSTAL_OF_PROGRESS6_ID, CRYSTAL_OF_INPROGRESS6_ID, CRYSTAL_OF_FOUL6_ID, CRYSTAL_OF_DEFEAT6_ID, CRYSTAL_OF_VICTORY6_ID }); // Silhoutte Tilfo
	}
	...
	{ // on the first attack, the stat is in battle... anytime gives crystal and set stat
		...
		if(npcId >= 27102 && npcId <= 27107)
		{
			...
			if(st.getPlayer().getSummons().length == 0)
				st.giveItems(i[2], 1);
		}
		return null;
	}
