...
import studio.lineage2.gameserver.model.pledge.UnitMember;
...
import studio.lineage2.gameserver.network.l2.s2c.ExMailArrivedPacket;
...
public final class CommunityClan extends ScriptsCommunityHandler
{
    ...
    protected void doBypassCommand(Player player, String bypass)
    {
        ...
        else if("bbsclanlist".equals(cmd))
        {
            ...
            TIntStringHashMap tpls = HtmCache.getInstance().getTemplates("scripts/services/community/bbs_clanlist.htm", player);
        ...
        else if("bbsclanhome".equals(cmd))
        {
            ...
            TIntStringHashMap tpls = HtmCache.getInstance().getTemplates("scripts/services/community/bbs_clan.htm", player);
            String html = tpls.getNotNull(0);
        ...
        else if("announcepledgewriteform".equals(cmd))
        {
            ...
            TIntStringHashMap tpls = HtmCache.getInstance().getTemplates("scripts/services/community/bbs_clanannounce.htm", player);
            String html = tpls.getNotNull(0);
    ...
    private class Listener implements OnPlayerEnterListener
    {
        ...
        public void onPlayerEnter(Player player)
        {
            ...
            {
                String html = HtmCache.getInstance().getHtml("scripts/services/community/clan_popup.htm", player);
                html = html.replace("%pledge_name%", clan.getName());
    ...
    static List<Clan> getClanList(String search, boolean byCL)
    {
