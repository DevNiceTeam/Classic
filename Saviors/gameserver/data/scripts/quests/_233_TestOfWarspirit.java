...
public final class _233_TestOfWarspirit extends Quest
{
	...
	{ HERMODTS_RIB_BONE, HERMODTS_SPINE, HERMODTS_THIGH_BONE, HERMODTS_ARM_BONE };
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(st.getCond() == 0)
		{
			...
			{
				return "seer_somak_q0233_01.htm";
			}
			if(st.getPlayer().getClassId().getId() != 0x32)
			{
				return "seer_somak_q0233_02.htm";
			}
			if(st.getPlayer().getLevel() < 39)
			{
				return "seer_somak_q0233_03.htm";
			}
