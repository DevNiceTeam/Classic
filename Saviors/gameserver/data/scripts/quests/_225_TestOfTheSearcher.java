...
public final class _225_TestOfTheSearcher extends Quest
{
	...
	public _225_TestOfTheSearcher()
	{
		...
		addRaceCheck(true, true, true, false, true);
		addClassIdCheck(7, 35, 22, 54);
		addLevelCheck(39);
	}
			...
			case Luther:
				if(cond == 0)
				{
					if(checkStartCondition(st.getPlayer()))
						htmltext = st.getPlayer().getClassId().getId() == 0x36 ? "master_luther_q0225_04.htm" : "master_luther_q0225_03.htm";
					else if(st.getPlayer().getClassId().ordinal() != 0x07 || st.getPlayer().getClassId().ordinal() != 0x16 || st.getPlayer().getClassId().ordinal() != 0x23 || st.getPlayer().getClassId().getId() == 0x36)
						htmltext = "master_luther_q0225_01.htm";
					else
						htmltext = "master_luther_q0225_02.htm";
				}
				else if(cond == 1)
