...
import studio.lineage2.gameserver.model.entity.events.impl.ClanHallAuctionEvent;
import studio.lineage2.gameserver.model.entity.events.impl.SiegeEvent;
import studio.lineage2.gameserver.model.entity.events.objects.AuctionSiegeClanObject;
...
public class AuctioneerInstance extends NpcInstance
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		{
			showChatWindow(player, getMapDialog(), false);
		}
		//=============================================================================================
