...
import studio.lineage2.gameserver.database.mysql;
import studio.lineage2.gameserver.handler.voicecommands.IVoicedCommandHandler;
import studio.lineage2.gameserver.handler.voicecommands.VoicedCommandHandler;
...
public class VoteManager implements IVoicedCommandHandler, OnInitScriptListener
{
	...
	public static void load()
	{
		...
		try
		{
			File file = new File(Config.DATAPACK_ROOT, "data/other/vote.xml");
