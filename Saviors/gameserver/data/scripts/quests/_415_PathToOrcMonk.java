...
public final class _415_PathToOrcMonk extends Quest
{
	...
	private static final int LeatherPouchFull2s = 1598;
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		switch(npcId)
		{
			...
			case Rosheek:
				...
				{
					st.takeItems(LeatherPouchFull2s, -1);
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		else if(cond == 5 && st.getQuestItemsCount(LeatherPouchFull2s) == 0)
		{
			st.takeItems(KashaBladeSpiderTalon, -1);
			st.takeItems(LeatherPouch2st, -1);
			st.giveItems(LeatherPouchFull2s, 1);
		}
