...
public final class _223_TestOfChampion extends Quest
{
	...
	public _223_TestOfChampion()
	{
		...
		addRaceCheck(true, false, false, true, false);
		addClassIdCheck(1, 45);
		addLevelCheck(39);
	}
			...
			case Ascalon:
				if(cond == 0)
				{
					if(checkStartCondition(st.getPlayer()))
						htmltext = class_id == ClassId.WARRIOR ? "veteran_ascalon_q0223_03.htm" : "veteran_ascalon_q0223_04.htm";
					else if(class_id != ClassId.WARRIOR && class_id != ClassId.ORC_RAIDER)
						htmltext = "veteran_ascalon_q0223_01.htm";
					else
						htmltext = "veteran_ascalon_q0223_02.htm";
				}
				else if(cond == COND1)
