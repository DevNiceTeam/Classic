...
import studio.lineage2.gameserver.model.items.Inventory;
...
public final class _229_TestOfWitchcraft extends Quest
{
	...
	public _229_TestOfWitchcraft()
	{
		...
		addRaceCheck(true, false, true, false, false);
		addClassIdCheck(4, 11, 32);
		addLevelCheck(39);
	}
			...
			case Orim:
				if(cond == 0)
				{
					if(checkStartCondition(st.getPlayer()))
						htmltext = st.getPlayer().getClassId().getId() == 0x0b ? "orim_the_shadow_q0229_03.htm" : "orim_the_shadow_q0229_05.htm";
					else if(st.getPlayer().getClassId().getId() != 0x0b || st.getPlayer().getClassId().getId() != 0x04 || st.getPlayer().getClassId().getId() != 0x20)
						htmltext = "orim_the_shadow_q0229_01.htm";
					else
						htmltext = "orim_the_shadow_q0229_02";
				}
				else if(cond == 1)
