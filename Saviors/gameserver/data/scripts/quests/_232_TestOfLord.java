...
import studio.lineage2.gameserver.model.quest.Drop;
...
public final class _232_TestOfLord extends Quest
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("kakai_the_lord_of_flame_q0232_08.htm"))
		{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(cond == 0)
		{
			...
			{
				return "kakai_the_lord_of_flame_q0232_01.htm";
			}
			if(st.getPlayer().getClassId().getId() != 0x32)
			{
				return "kakai_the_lord_of_flame_q0232_02.htm";
			}
			if(st.getPlayer().getLevel() < 39)
			{
				return "kakai_the_lord_of_flame_q0232_03.htm";
			}
