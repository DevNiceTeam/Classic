 ...
 */
public class _74_SagaOfTheDreadnoughts extends SagaThirdClassChange
{
    //TODO [Averen] переписать все диалоги
    public _74_SagaOfTheDreadnoughts()
    {
        NPC = new int[]{
                30851,
                30121,
        ...
        addQuestParams(ClassId.WARLORD, ClassId.DREADNOUGHT, 90038);
